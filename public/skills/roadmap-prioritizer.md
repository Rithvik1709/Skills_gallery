...
## Description
Compare opportunities by impact, confidence, effort, dependencies, and sequencing.
...
5. Draft the core deliverable with domain-specific detail for roadmap, priorities, planning.
...
### Main Deliverable
The full roadmap prioritizer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete product task related to roadmap, priorities, planning. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Roadmap Prioritizer to create a PRD from customer notes.
