...
## Description
Draft fair performance feedback with examples, impact, growth areas, and goals.
...
5. Draft the core deliverable with domain-specific detail for feedback, reviews, goals.
...
### Main Deliverable
The full performance review coach output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete hr task related to feedback, reviews, goals. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Performance Review Coach to write a fair performance review from notes.
