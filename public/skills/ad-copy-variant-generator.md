...
title: Ad Copy Variant Generator
use_case: marketing
difficulty: Beginner
tags:
  - ads
...
## Description
Produce ad angles, headlines, body variants, CTAs, and experiment notes.
...
5. Draft the core deliverable with domain-specific detail for ads, copy, testing.
...
### Main Deliverable
The full ad copy variant generator output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete marketing task related to ads, copy, testing. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Ad Copy Variant Generator to plan a campaign for a product launch.
