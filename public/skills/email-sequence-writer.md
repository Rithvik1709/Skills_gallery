...
## Description
Draft onboarding, nurture, sales, or internal email flows with subject lines.
...
5. Draft the core deliverable with domain-specific detail for email, sequence, copy.
...
### Main Deliverable
The full email sequence writer output. This section should contain the actual work, not instructions to do the work later.
