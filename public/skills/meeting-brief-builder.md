...
## Description
Prepare agendas, context, decisions needed, stakeholder notes, and follow-up templates.
...
5. Draft the core deliverable with domain-specific detail for meetings, agenda, decisions.
...
### Main Deliverable
The full meeting brief builder output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete business task related to meetings, agenda, decisions. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Meeting Brief Builder to prepare a decision memo for leadership.
