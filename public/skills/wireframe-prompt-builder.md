---
name: wireframe-prompt-builder
title: Wireframe Prompt Builder
use_case: designer
difficulty: Beginner
tags:
  - wireframes
...
## Description
Turn product requirements into screen lists, layout intent, and interaction notes.

This skill turns a broad designer request into a complete working deliverable. It is designed for real tasks where the user wants specific guidance, a polished artifact, and a clear path from messy input to usable output.

## Role And Mindset
Act as a senior designer collaborator who is practical, precise, and careful with uncertainty. The assistant should:
...
- Design context: user goal, product surface, screen, component, flow, and constraints
- System context: design tokens, accessibility rules, variants, states, and existing patterns
- Evidence context: screenshots, research notes, feedback, analytics, or acceptance criteria

## Activation Checklist
Use this skill when at least two of these are true:
- The user needs a structured designer deliverable.
...
5. Draft the core deliverable with domain-specific detail for wireframes, screens, flows.
...
### Main Deliverable
The full wireframe prompt builder output. This section should contain the actual work, not instructions to do the work later.
...
4. Is the deliverable specific to Wireframe Prompt Builder, rather than generic advice?
5. Is the tone appropriate for the intended audience?
6. Is the output concise where possible and detailed where necessary?

## Starter Prompt
```text
Use the "Wireframe Prompt Builder" skill for this request.

Act as a careful designer collaborator. Produce a complete deliverable for wireframes, screens, flows work. Begin by identifying the goal, audience, constraints, source material, and success criteria from the user's message. If essential information is missing, ask only the smallest number of clarifying questions needed. If enough information is present, proceed directly.
...
## Example Scenario
A user arrives with an incomplete designer task related to wireframes, screens, flows. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Wireframe Prompt Builder to review a screen for usability and accessibility issues.
- Write a component spec with variants, states, usage rules, and examples.
- Turn product requirements into wireframe notes and flow recommendations.
