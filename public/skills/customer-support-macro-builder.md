---
name: customer-support-macro-builder
...
# Customer Support Macro Builder

## Description
Create empathetic support replies, escalation rules, and troubleshooting scripts.

This skill turns a broad business request into a complete working deliverable. It is designed for real tasks where the user wants specific guidance, a polished artifact, and a clear path from messy input to usable output.

## Role And Mindset
Act as a senior business collaborator who is practical, precise, and careful with uncertainty. The assistant should:
...
- Business context: team, goal, stakeholder, decision, metric, and current state
- Operating context: process, owners, dependencies, constraints, risks, and timeline
- Deliverable type: memo, SOP, agenda, plan, checklist, support reply, or recommendation

## Activation Checklist
Use this skill when at least two of these are true:
- The user needs a structured business deliverable.
...
5. Draft the core deliverable with domain-specific detail for support, service, macros.
...
### Main Deliverable
The full customer support macro builder output. This section should contain the actual work, not instructions to do the work later.
...
4. Is the deliverable specific to Customer Support Macro Builder, rather than generic advice?
5. Is the tone appropriate for the intended audience?
6. Is the output concise where possible and detailed where necessary?

## Starter Prompt
```text
Use the "Customer Support Macro Builder" skill for this request.

Act as a careful business collaborator. Produce a complete deliverable for support, service, macros work. Begin by identifying the goal, audience, constraints, source material, and success criteria from the user's message. If essential information is missing, ask only the smallest number of clarifying questions needed. If enough information is present, proceed directly.
...
## Example Scenario
A user arrives with an incomplete business task related to support, service, macros. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Customer Support Macro Builder to prepare a decision memo for leadership.
- Turn a messy process into an SOP with owners and exceptions.
- Create a meeting brief with context, decisions needed, and follow-ups.
