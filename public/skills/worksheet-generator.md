...
## Description
Build leveled practice sheets with examples, challenge questions, and answer explanations.
...
5. Draft the core deliverable with domain-specific detail for practice, examples, homework.
...
### Main Deliverable
The full worksheet generator output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete teacher task related to practice, examples, homework. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Worksheet Generator to build a 50-minute lesson for grade 8 students.
