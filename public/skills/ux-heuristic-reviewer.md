...
## Description
Review screens for clarity, hierarchy, accessibility, states, friction, and visual polish.
...
5. Draft the core deliverable with domain-specific detail for ux, accessibility, review.
...
### Main Deliverable
The full ux heuristic reviewer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete designer task related to ux, accessibility, review. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use UX Heuristic Reviewer to review a screen for usability and accessibility issues.
