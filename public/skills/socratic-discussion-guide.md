---
name: socratic-discussion-guide
...
## Description
Prepare prompts, follow-ups, discussion arcs, and evidence-based participation goals.
...
5. Draft the core deliverable with domain-specific detail for discussion, questions, seminar.
...
### Main Deliverable
The full socratic discussion guide output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete teacher task related to discussion, questions, seminar. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Socratic Discussion Guide to build a 50-minute lesson for grade 8 students.
