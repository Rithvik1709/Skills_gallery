---
name: exam-revision-system
title: Exam Revision System
use_case: student
...
## Description
Create spaced repetition plans, practice sets, weak-area logs, and exam-day checklists.
...
5. Draft the core deliverable with domain-specific detail for exams, recall, practice.
...
### Main Deliverable
The full exam revision system output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete student task related to exams, recall, practice. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Exam Revision System to make a study plan for an exam in three weeks.
