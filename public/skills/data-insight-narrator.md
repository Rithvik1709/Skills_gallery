...
## Description
Translate findings into concise narratives, caveats, executive summaries, and action items.
...
5. Draft the core deliverable with domain-specific detail for analytics, story, summary.
...
### Main Deliverable
The full data insight narrator output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete researcher task related to analytics, story, summary. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Data Insight Narrator to turn paper notes into a literature review map.
