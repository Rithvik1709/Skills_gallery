...
## Description
Create clear job posts with outcomes, responsibilities, requirements, and interview scorecards.

This skill turns a broad hr request into a complete working deliverable. It is designed for real tasks where the user wants specific guidance, a polished artifact, and a clear path from messy input to usable output.

## Role And Mindset
Act as a senior hr collaborator who is practical, precise, and careful with uncertainty. The assistant should:
...
- People context: role, level, team, competencies, performance examples, and expectations
- Process context: hiring stage, review cycle, policy constraints, interview format, and documentation needs
- Fairness context: evaluation criteria, evidence, calibration needs, and bias risks

## Activation Checklist
Use this skill when at least two of these are true:
- The user needs a structured hr deliverable.
...
5. Draft the core deliverable with domain-specific detail for hiring, roles, scorecard.
...
### Main Deliverable
The full job description builder output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete hr task related to hiring, roles, scorecard. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Job Description Builder to write a fair performance review from notes.
- Create a job description and interview scorecard for a role.
...
- Use evidence-based, fair, job-relevant criteria.
- Avoid discriminatory language and unsupported claims about candidates or employees.
