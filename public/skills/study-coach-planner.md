...
## Description
Build adaptive study plans with milestones, recall drills, reflection prompts, and reviews.
...
5. Draft the core deliverable with domain-specific detail for planning, habits, review.
...
### Main Deliverable
The full study coach planner output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete student task related to planning, habits, review. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Study Coach Planner to make a study plan for an exam in three weeks.
