...
## Description
Structure incident timelines, impact, root causes, fixes, and prevention actions.
...
5. Draft the core deliverable with domain-specific detail for incident, postmortem, security.
...
### Main Deliverable
The full incident postmortem writer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete security task related to incident, postmortem, security. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Incident Postmortem Writer to build a threat model for a system.
