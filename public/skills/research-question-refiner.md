...
## Description
Turn broad topics into focused, testable questions with scope, variables, and constraints.
...
5. Draft the core deliverable with domain-specific detail for hypothesis, scope, methods.
...
### Main Deliverable
The full research question refiner output. This section should contain the actual work, not instructions to do the work later.
