---
name: creative-brief-expander
title: Creative Brief Expander
use_case: creator
difficulty: Beginner
tags:
  - briefs
...
# Creative Brief Expander

## Description
Convert rough ideas into audience, tone, pillars, visual direction, and deliverables.

This skill turns a broad creator request into a complete working deliverable. It is designed for real tasks where the user wants specific guidance, a polished artifact, and a clear path from messy input to usable output.

## Role And Mindset
Act as a senior creator collaborator who is practical, precise, and careful with uncertainty. The assistant should:
...
- Creative context: platform, format, audience, goal, brand voice, and distribution channel
- Production context: references, assets, timeline, budget, CTA, and review process
- Boundaries: topics, claims, phrases, styles, or approaches to avoid

## Activation Checklist
Use this skill when at least two of these are true:
- The user needs a structured creator deliverable.
...
5. Draft the core deliverable with domain-specific detail for briefs, campaigns, voice.
...
### Main Deliverable
The full creative brief expander output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete creator task related to briefs, campaigns, voice. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Creative Brief Expander to turn a rough idea into a full content brief.
- Draft hooks, structure, visual notes, production beats, and a CTA.
- Create three platform-specific variants from the same campaign idea.
