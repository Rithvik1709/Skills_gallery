...
## Description
Review changes for bugs, regressions, tests, edge cases, and maintainability.
...
5. Draft the core deliverable with domain-specific detail for reviews, testing, quality.
...
### Main Deliverable
The full code review partner output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete developer task related to reviews, testing, quality. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Apply Code Review Partner to a code diff and list the highest-risk issues.
