...
## Description
Create user stories, acceptance criteria, edge cases, and release notes.
...
5. Draft the core deliverable with domain-specific detail for stories, criteria, delivery.
...
### Main Deliverable
The full user story generator output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete product task related to stories, criteria, delivery. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use User Story Generator to create a PRD from customer notes.
