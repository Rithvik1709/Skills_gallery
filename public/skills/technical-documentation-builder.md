...
## Description
Create docs with prerequisites, steps, examples, troubleshooting, and changelog notes.
...
5. Draft the core deliverable with domain-specific detail for docs, how-to, reference.
...
### Main Deliverable
The full technical documentation builder output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete writer task related to docs, how-to, reference. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Technical Documentation Builder to improve a draft for clarity, structure, and audience fit.
