---
name: clinical-note-organizer
title: Clinical Note Organizer
use_case: healthcare
difficulty: Advanced
tags:
  - notes
...
# Clinical Note Organizer

## Description
Organize encounter notes into structured summaries for clinician review.
...
5. Draft the core deliverable with domain-specific detail for notes, clinical, summary.
...
### Main Deliverable
The full clinical note organizer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete healthcare task related to notes, clinical, summary. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Clinical Note Organizer to organize notes for clinician review.
