...
## Description
Draft short-form or long-form scripts with hooks, beats, shot notes, and CTAs.
...
5. Draft the core deliverable with domain-specific detail for video, script, story.
...
### Main Deliverable
The full video script producer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete creator task related to video, script, story. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Video Script Producer to turn a rough idea into a full content brief.
