...
## Description
Map papers into themes, evidence tables, gaps, disagreements, and next research questions.
...
5. Draft the core deliverable with domain-specific detail for papers, citations, synthesis.
...
### Main Deliverable
The full literature review synthesizer output. This section should contain the actual work, not instructions to do the work later.
