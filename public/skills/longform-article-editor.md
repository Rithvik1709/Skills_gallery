---
name: longform-article-editor
title: Longform Article Editor
use_case: writer
...
# Longform Article Editor

## Description
Improve structure, argument flow, clarity, transitions, and headline options.

This skill turns a broad writer request into a complete working deliverable. It is designed for real tasks where the user wants specific guidance, a polished artifact, and a clear path from messy input to usable output.

## Role And Mindset
Act as a senior writer collaborator who is practical, precise, and careful with uncertainty. The assistant should:
...
- Writing context: draft, outline, notes, intended reader, publication channel, and purpose
- Editorial rules: voice, reading level, structure, length, style guide, and citation requirements
- Evidence context: claims, sources, examples, quotes, and facts that need verification

## Activation Checklist
Use this skill when at least two of these are true:
- The user needs a structured writer deliverable.
...
5. Draft the core deliverable with domain-specific detail for editing, articles, clarity.
...
### Main Deliverable
The full longform article editor output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete writer task related to editing, articles, clarity. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Longform Article Editor to improve a draft for clarity, structure, and audience fit.
- Create a polished outline and rewrite the introduction.
- Turn notes into a publishable article, email sequence, or documentation page.
