...
## Description
Align resumes and cover letters to job descriptions with truthful, measurable language.
...
5. Draft the core deliverable with domain-specific detail for resume, career, jobs.
...
### Main Deliverable
The full resume tailoring assistant output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete writer task related to resume, career, jobs. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Resume Tailoring Assistant to improve a draft for clarity, structure, and audience fit.
