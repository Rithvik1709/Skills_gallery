...
## Description
Define component anatomy, variants, props, usage rules, states, and examples.
...
5. Draft the core deliverable with domain-specific detail for components, tokens, system.
...
### Main Deliverable
The full design system component spec output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete designer task related to components, tokens, system. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Design System Component Spec to review a screen for usability and accessibility issues.
