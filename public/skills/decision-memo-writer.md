...
## Description
Structure options, tradeoffs, costs, risks, recommendation, and owner-ready next steps.
...
5. Draft the core deliverable with domain-specific detail for strategy, memo, tradeoffs.
...
### Main Deliverable
The full decision memo writer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete business task related to strategy, memo, tradeoffs. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Decision Memo Writer to prepare a decision memo for leadership.
