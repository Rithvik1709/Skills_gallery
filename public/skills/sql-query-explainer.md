...
## Description
Explain SQL logic, joins, filters, performance risks, and validation checks.
...
5. Draft the core deliverable with domain-specific detail for sql, analysis, validation.
...
### Main Deliverable
The full sql query explainer output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete data task related to sql, analysis, validation. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use SQL Query Explainer to explain a dashboard to executives.
