---
name: iep-accommodation-adapter
title: IEP Accommodation Adapter
use_case: teacher
difficulty: Advanced
tags:
  - accessibility
...
# IEP Accommodation Adapter

## Description
Adapt lessons for accessibility, pacing, modalities, and documented learning supports.
...
5. Draft the core deliverable with domain-specific detail for accessibility, support, planning.
...
### Main Deliverable
The full iep accommodation adapter output. This section should contain the actual work, not instructions to do the work later.
...
4. Is the deliverable specific to IEP Accommodation Adapter, rather than generic advice?
5. Is the tone appropriate for the intended audience?
6. Is the output concise where possible and detailed where necessary?

## Starter Prompt
```text
Use the "IEP Accommodation Adapter" skill for this request.
