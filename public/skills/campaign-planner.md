...
## Description
Build positioning, audience, channels, messaging, launch calendar, and measurement plan.
...
5. Draft the core deliverable with domain-specific detail for campaigns, launch, channels.
...
### Main Deliverable
The full campaign planner output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete marketing task related to campaigns, launch, channels. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Campaign Planner to plan a campaign for a product launch.
