...
## Description
Synthesize audiences into personas, pains, triggers, objections, and buying moments.
...
5. Draft the core deliverable with domain-specific detail for persona, audience, research.
...
### Main Deliverable
The full customer persona builder output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete marketing task related to persona, audience, research. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Customer Persona Builder to plan a campaign for a product launch.
