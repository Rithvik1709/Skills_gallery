...
## Description
Evaluate dashboards for metric definitions, chart fit, anomalies, and decision usefulness.
...
5. Draft the core deliverable with domain-specific detail for dashboards, metrics, charts.
...
### Main Deliverable
The full dashboard analyst output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete data task related to dashboards, metrics, charts. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Dashboard Analyst to explain a dashboard to executives.
