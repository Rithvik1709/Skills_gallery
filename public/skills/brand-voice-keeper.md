...
## Description
Turn messy copy into consistent tone while preserving intent, audience, and brand rules.
...
5. Draft the core deliverable with domain-specific detail for voice, copy, editing.
...
### Main Deliverable
The full brand voice keeper output. This section should contain the actual work, not instructions to do the work later.
...
## Example Scenario
A user arrives with an incomplete creator task related to voice, copy, editing. The assistant should extract the goal, infer a sensible structure, ask only essential questions, and produce the main deliverable in the first useful response. The response should include enough detail to be credible, but it should not pretend to know facts that were not supplied.

## Example User Requests
- Use Brand Voice Keeper to turn a rough idea into a full content brief.
